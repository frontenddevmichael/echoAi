    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-muted/50 border border-border mb-8"
        >
        ...
        >
          {[
            ...
            { icon: Code2, label: 'Generate' },
            { icon: Wrench, label: 'Debug' },
            { icon: Sparkles, label: 'Explain' },
          ].map(({ icon: Icon, label }) => (
            <div
              key={label}
              className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-muted/30 border border-border text-sm text-muted-foreground"
            >
